        ...
        <div class="main-wrapper">
                        ...
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>img/hero.png">
                            <div class="hero-inner">
                                <h1>Selamat Datang, <?php
                                                    ...
                                                    echo $data['user']['nama_publisher'];
                                                    ?>!</h1>
                                <p class="lead">Di Halaman Publisher - W2lay | Web Portal Game Indonesia - <br> Pertama di
                                    Indonesia</p>
                                <div class="mt-4">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2020 <div class="bullet"></div> Program & Design by <a href="syauqizaidan.github.io">MhrCtrFrnz and Rian</a> and MhrCtrFrnz and Rian -  Developer
                </div>
                <div class="footer-right">
                    Made with <span class="text-danger"> &#10084;</span> by MhrCtrFrnz and Rian
                </div>
            </footer>
        </div>
    </div>
