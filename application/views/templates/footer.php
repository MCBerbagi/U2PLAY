...
<footer class="page-footer font-small pt-4 mt-5">
    <div class="container">
        ...
        <div class="container-fluid text-center text-md-left">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-md-0 mt-3">
                    ...
                    <!-- Content -->
                    <h3 class="text-uppercase footer-text">Tentang W2play.</h3>
                    <p>W2play Adalah portal game pertama di indonesia, yang menyediakan fasilitas untuk para
                        developer
        ...
        <div class="footer-copyright text-center small py-3">© 2020 Copyright :
            <a href="" class="text-white"> MhrCtrFrnz</a>
        </div>
    </div>
    <!-- Copyright -->
